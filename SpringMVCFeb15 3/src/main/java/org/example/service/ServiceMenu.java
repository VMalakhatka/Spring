...
public class ServiceMenu {
    ...
    @Autowired
    public ServiceMenu(DishMapper dishMapper, MenuDao menuDao, IngredientRepository ingredientRepository) {
    ...
    public DishResponseDto create(DishCreateRequestDto candidate) {
        Set<Ingredient> ingredientSet = new HashSet<>(ingredientRepository.findAllById(candidate.ingredientIds()));
