...
public class EndingWindow extends JDialog {
    ...
    public EndingWindow(JFrame owner, String winName) {
        super(owner, winName, true);

        GridBagLayout layout = new GridBagLayout();
        Container contentPane = getContentPane();
        contentPane.setLayout(layout);

        contentPane.add(createEndLabel(layout, winName));
    ...
    private JLabel createEndLabel(GridBagLayout layout, String winName) {
        JLabel label = new JLabel("You " + winName.toLowerCase() + "!");
